...
$newstatsQuery = "SELECT count(`status`) as 'count' from `candidats` 
 where status='Nouveau'  AND staff_aff = '".$user."' ".$query_where." ".$groupby ;
$newstatsRecords = mysqli_query($con, $newstatsQuery);
$newcount_status_today = mysqli_num_rows($newstatsRecords);


$statsQuery = "SELECT count(`status`) as 'count' from `candidats` where staff_aff = '".$user."'  ".$query_where2." ".$groupby ;
...
$valstatsQuery = "SELECT count(`status`) as 'count' from `candidats` 
 where status='Validé'  AND staff_aff = '".$user."' ".$query_where." ".$groupby ;
...
$refstatsQuery = "SELECT count(`status`) as 'count' from `candidats` 
 where status='Refusé'  AND staff_aff = '".$user."' ".$query_where." ".$groupby ;
...
$entstatsQuery1 = "SELECT count(`status`) as 'count' from `candidats` 
 where status='1er Entretien'  AND staff_aff = '".$user."' ".$query_where." ".$groupby ;
...
$entstatsQuery2 = "SELECT count(`status`) as 'count' from `candidats` 
 where status='2eme Entretien'  AND staff_aff = '".$user."'  ".$query_where." ".$groupby ;
...
$rep1statsQuery = "SELECT count(`status`) as 'count' from `candidats` 
 where status='Ne repond pas1' AND staff_aff = '".$user."'  ".$query_where." ".$groupby ;
...
$rep2statsQuery = "SELECT count(`status`) as 'count' from `candidats` 
 where status='Ne repond pas2' AND staff_aff = '".$user."'  ".$query_where." ".$groupby ;
...
$fkostatsQuery = "SELECT count(`status`) as 'count' from `candidats` 
 where status='Français KO' AND staff_aff = '".$user."'  ".$query_where." ".$groupby ;
...
$dblstatsQuery = "SELECT count(`status`) as 'count' from `candidats` 
 where status='Doublon' AND staff_aff = '".$user."'  ".$query_where." ".$groupby ;
...
$adkostatsQuery = "SELECT count(`status`) as 'count' from `candidats` 
 where status='Administratif KO' AND staff_aff = '".$user."'  ".$query_where." ".$groupby ;
...
$aphystatsQuery = "SELECT count(`status`) as 'count' from `candidats` 
 where status='Abs entretien physique' AND staff_aff = '".$user."'  ".$query_where." ".$groupby ;
...
$empQuery = "SELECT * FROM candidats where staff_aff = '".$user."'  ".$query_where2." ".$groupby ;

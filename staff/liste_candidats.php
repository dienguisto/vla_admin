...
if ($_SESSION['valid'] == true)
{
  ...
  if($_SESSION['username']  == 'jakli2' || $_SESSION['username']  == 'srachad2' || $_SESSION['username']  == 'salwatik' || $_SESSION['username'] == 'ioujik' || $_SESSION['username']  == 'bboutlast' || 
    $_SESSION['username'] == 'smouhim' || $_SESSION['username'] == 'aalami' || $_SESSION['username'] == 'yhayate' || $_SESSION['username'] == 'yharcha'){
...
$where=" WHERE staff_aff = '".$_SESSION['username']."'  GROUP BY telephone ORDER BY `id_candidat` DESC";
  ?>
...
<div class="frm-row">
    ...
    <?php
if($_SESSION['username']  == 'srachad2' ||  $_SESSION['username']  == 'salwatik' || $_SESSION['username']  == 'ioujik' || $_SESSION['username']  == 'aalami'){

echo '<option value="srachad">Soumia Rachad</option>';

}elseif($_SESSION['username']  == 'jakli2' ||  $_SESSION['username']  == 'bboutlast' || $_SESSION['username']  == 'smouhim' || $_SESSION['username']  == 'yhayate'){

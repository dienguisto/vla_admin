<?php 
  ...
  if($_SESSION['username']  == 'jakli2' || $_SESSION['username']  == 'srachad2' || $_SESSION['username']  == 'salwatik' || $_SESSION['username'] == 'ioujik' || $_SESSION['username']  == 'bboutlast' || $_SESSION['username'] == 'smouhim' || $_SESSION['username'] == 'aalami' || $_SESSION['username'] == 'yhayate' || $_SESSION['username'] == 'yharcha'){


  $newstatsQuery = "SELECT * from `candidats` 
 where status='Nouveau' AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone";
$newstatsRecords = mysqli_query($con, $newstatsQuery);
$newcount_status_today = mysqli_num_rows($newstatsRecords);


$statsQuery = "SELECT * from `candidats` where staff_aff = '".$_SESSION['username']."'  GROUP BY telephone ";
...
$valstatsQuery = "SELECT * from `candidats` 
 where status='Validé' AND staff_aff = '".$_SESSION['username']."' GROUP BY telephone ";
...
$refstatsQuery = "SELECT * from `candidats` 
 where status='Refusé' AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone";
...
$entstatsQuery1 = "SELECT * from `candidats` 
 where status='1er Entretien' AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone ";
...
$entstatsQuery2 = "SELECT * from `candidats` 
 where status='2eme Entretien'  AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone";
...
$rep1statsQuery = "SELECT * from `candidats` 
 where status='Ne repond pas1' AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone";
...
$rep2statsQuery = "SELECT * from `candidats` 
 where status='Ne repond pas2' AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone";
...
$fkostatsQuery = "SELECT * from `candidats` 
 where status='Français KO' AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone";
...
$dblstatsQuery = "SELECT * from `candidats` 
 where status='Doublon' AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone";
...
$adkostatsQuery = "SELECT * from `candidats` 
 where status='Administratif KO' AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone";
...
$aphystatsQuery = "SELECT * from `candidats` 
 where status='Abs entretien physique' AND staff_aff = '".$_SESSION['username']."'  GROUP BY telephone";

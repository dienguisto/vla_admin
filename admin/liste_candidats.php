...
<div class="frm-row">
    ...
    <option value="sophia">Sofia HACHAD</option>
...
$status_par = $row['user_status'];
$staff = $row['staff_aff'];
if($staff  == 'srachad' || $staff  == 'srachad2' || $staff  == 'salwatik' || $staff  == 'ioujik' ){
  $status_par = 'srachad';
}elseif($staff  == 'jakli' || $staff  == 'jakli2' || $staff  == 'smouhim' || $staff  == 'bboutlast'){
  $status_par = 'jakli';
}elseif($staff  == 'yharcha'){
  $status_par = 'sophia';
}else{
  $status_par = '-';
}

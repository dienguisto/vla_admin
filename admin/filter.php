...
if($user_status  == 'srachad' || $user_status  == 'srachad2' || $user_status  == 'salwatik' || $user_status  == 'ioujik' ){
  $user_status = 'srachad';
}elseif($user_status  == 'jakli' || $user_status  == 'jakli2' || $user_status  == 'smouhim' || $user_status  == 'bboutlast'){
  $user_status = 'jakli';
}elseif($user_status  == 'sophia' || $user_status  == 'yharcha'){
  $user_status = 'sophia';
}else{
  $user_status = '';
}
...
$newstatsQuery = "SELECT * from `candidats` 
 where status='Nouveau' ".$query_where." ".$groupby ;
$newstatsRecords = mysqli_query($con, $newstatsQuery);
$newcount_status_today = mysqli_num_rows($newstatsRecords);


$statsQuery = "SELECT * from `candidats` where 1 ".$query_where2." ".$groupby ;
...
$valstatsQuery = "SELECT * from `candidats` 
 where status='Validé' ".$query_where." ".$groupby ;
...
$refstatsQuery = "SELECT * from `candidats` 
 where status='Refusé' ".$query_where." ".$groupby ;
...
$entstatsQuery1 = "SELECT * from `candidats` 
 where status='1er Entretien' ".$query_where." ".$groupby ;
...
$entstatsQuery2 = "SELECT * from `candidats` 
 where status='2eme Entretien'  ".$query_where." ".$groupby ;
...
$rep1statsQuery = "SELECT * from `candidats` 
 where status='Ne repond pas1' ".$query_where." ".$groupby ;
...
$rep2statsQuery = "SELECT * from `candidats` 
 where status='Ne repond pas2' ".$query_where." ".$groupby;
...
$fkostatsQuery = "SELECT * from `candidats` 
 where status='Français KO' ".$query_where." ".$groupby ;
...
$dblstatsQuery = "SELECT * from `candidats` 
 where status='Doublon' ".$query_where." ".$groupby ;
...
$adkostatsQuery = "SELECT * from `candidats` 
 where status='Administratif KO' ".$query_where." ".$groupby ;
...
$aphystatsQuery = "SELECT * from `candidats` 
 where status='Abs entretien physique' ".$query_where." ".$groupby ;
...
$empQuery = "SELECT * FROM candidats where 1 ".$query_where2." ".$groupby ;;

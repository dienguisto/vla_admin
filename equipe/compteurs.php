<?php 
  ...
  if($_SESSION['username']  == 'srachad' || $_SESSION['username']  == 'jakli' || $_SESSION['username']  == 'sophia' ){


  $newstatsQuery = "SELECT * from `candidats` 
 where status='Nouveau' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
$newstatsRecords = mysqli_query($con, $newstatsQuery);
$newcount_status_today = mysqli_num_rows($newstatsRecords);


$statsQuery = "SELECT * from `candidats` where user_status = '".$_SESSION['username']."'  GROUP BY telephone ";
...
$valstatsQuery = "SELECT * from `candidats` 
 where status='Validé' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
...
$refstatsQuery = "SELECT * from `candidats` 
 where status='Refusé' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
...
$entstatsQuery1 = "SELECT * from `candidats` 
 where status='1er Entretien' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
...
$entstatsQuery2 = "SELECT * from `candidats` 
 where status='2eme Entretien'  AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
...
$rep1statsQuery = "SELECT * from `candidats` 
 where status='Ne repond pas1' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
...
$rep2statsQuery = "SELECT * from `candidats` 
 where status='Ne repond pas2' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
...
$fkostatsQuery = "SELECT * from `candidats` 
 where status='Français KO' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
...
$dblstatsQuery = "SELECT * from `candidats` 
 where status='Doublon' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
...
$adkostatsQuery = "SELECT * from `candidats` 
 where status='Administratif KO' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
...
$aphystatsQuery = "SELECT * from `candidats` 
 where status='Abs entretien physique' AND user_status = '".$_SESSION['username']."'  GROUP BY telephone";
